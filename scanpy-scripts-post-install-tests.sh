...
export pca_image_file2="$output_dir/pca2.png"
export pca_embeddings_file2="$output_dir/pca_embeddings2.csv"
export pca_loadings_file2="$output_dir/pca_loadings2.csv"
export pca_stdev_file2="$output_dir/pca_stdev2.txt"
export pca_var_ratio_file2="$output_dir/pca_var_ratio2.txt"
...
export cluster_text_file2="$output_dir/clusters2.txt"
